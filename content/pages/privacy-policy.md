...
AGESCI Gruppo Mirandola 1, con sede in via Cavour 2, Mirandola (MO).
...
Cookie di preferenza: memorizzano eventuali impostazioni di base selezionate dall’utente, come la lingua del sito o le preferenze di visualizzazione, per ottimizzare l’esperienza d’uso. Modalità di trattamento: I cookie tecnici utilizzati sul sito sono gestiti in modo da prevenire accessi non autorizzati, garantendo la protezione delle impostazioni di navigazione basilari degli utenti. Nessun dato personale è raccolto o memorizzato durante la navigazione sul sito.
